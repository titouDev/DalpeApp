...
Ext.define('dalpeApp.controller.sousTraitants', {
    ...
    onAddSousTraitantClick: function(button, e, options) {
    ...
    onRefreshClick: function(tool, e, options) {
        this.reloadSousTraitantsStore();
    },

    onSousTraitantsGridItemContextMenu: function(tablepanel, record, item, index, e, options) {
    ...
    onContextMenuClick: function(menu, item, e, options) {
        switch(item.itemId)
        {
            case 'delete':
            console.log(123);
    ...
    onSousTraitantsGridItemDblClick: function(tablepanel, record, item, index, e, options) {
        //On ouvre la fenetre d'edition de soustraitant

        this.displayEditSousTraitantWindow();
    },

    onRefreshClickMailsGrid: function(tool, e, options) {
    ...
    onComboSpecialitesSelect: function(combo, records, options) {
        this.reloadSousTraitantsStore();
        this.resetMailsGrid();
    },

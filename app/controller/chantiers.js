...
Ext.define('dalpeApp.controller.chantiers', {
    ...
    onChantiersGridItemDblClick: function(tablepanel, record, item, index, e, options) {
    ...
    onChantiersGridSelect: function(selModel, record, index, options) {
    ...
    onFileUpdalodChange: function(filefield, value, options) {
    ...
    onChantiersPanelActivate: function(abstractcomponent, options) {

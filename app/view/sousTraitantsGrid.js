...
Ext.define('dalpeApp.view.sousTraitantsGrid', {
    ...
    onGridviewBeforeRefresh: function(abstractview, options) {
        abstractview.scrollTop = abstractview.container.dom.firstChild.scrollTop;
    },

    onGridviewRefresh: function(abstractview, options) {
        abstractview.container.dom.firstChild.scrollTop = abstractview.scrollTop;
    }
